...
int main()
{
    ...
    while (seguir)
    {
        ...
        else if (cmd_es("copiarFecha", cmd))
        { // Copia la fecha almacenada en la variable fecha en otra variable fecha
        ...
        else if (cmd_es("crearEvento", cmd))
        { // Crea un evento y lo almacena en la variable evento
            main_crearEvento(evento, fecha);
        }
        else if (cmd_es("imprimirIdEvento", cmd))
        { // Imprime el id del evento almacenado en la variable evento
            main_imprimirIdEvento(evento);
        }
        else if (cmd_es("imprimirFechaEvento", cmd))
        { // Imprime la fecha del evento almacenado en la variable evento
            main_imprimirFechaEvento(evento);
        }
        else if (cmd_es("imprimirEvento", cmd))
        { // Imprime toda la infromación del evento almacenado en la variable evento
            main_imprimirEvento(evento);
        }
        else if (cmd_es("liberarEvento", cmd))
        { // Libera la memoria del evento almacenado en la variable evento
            main_liberarEvento(evento);
        }
        else if (cmd_es("posponerEvento", cmd))
        { // Pospone el evento almacenado en la variable evento una cantidad de días indicada
            main_posponerEvento(evento);
        }
        else if (cmd_es("copiarEvento", cmd))
        { // Copia el evento almacenado en la variable evento en otra variable evento
        ...
        else if (cmd_es("crearAgenda", cmd))
        { // Crea una agenda y la almacena en la variable agenda
            main_crearAgenda(agenda);
        }
        else if (cmd_es("agregarEnAgenda", cmd))
        { // Agrega el evento almacenado en la variable evento a la agenda almacenada en la variable agenda
            main_agregarEnAgenda(agenda, evento);
        }
        else if (cmd_es("imprimirAgenda", cmd))
        { // Imprime toda la información de la agenda almacenada en la variable agenda
            main_imprimirAgenda(agenda);
        }
        else if (cmd_es("liberarAgenda", cmd))
        { // Libera la memoria de la agenda almacenada en la variable agenda
            main_liberarAgenda(agenda);
        }
        else if (cmd_es("estaEnAgenda", cmd))
        { // Indica si el evento almacenado en la variable evento está en la agenda almacenada en la variable agenda
            main_estaEnAgenda(agenda);
        }
        else if (cmd_es("posponerEnAgenda", cmd))
        { // Pospone el evento almacenado en la variable evento una cantidad de días indicada en la agenda almacenada en la variable agenda
            main_posponerEnAgenda(agenda);
        }
        else if (cmd_es("removerDeAgenda", cmd))
        { // Remueve el evento almacenado en la variable evento de la agenda almacenada en la variable agenda
            main_removerDeAgenda(agenda);
        }
        else if (cmd_es("hayEventosFechaAgenda", cmd))
        { // Indica si hay eventos en la agenda en una fecha indicada
            main_hayEventosFechaAgenda(agenda);
        }
        else if (cmd_es("imprimirEventosFechaAgenda", cmd))
        { // Imprime todos los eventos de la agenda con fecha igual a la indicada
            main_imprimirEventosFechaAgenda(agenda);
        }
        else if (cmd_es("imprimirCopiaAgenda", cmd))
        { // Imprime una copia de la agenda almacenada en la variable agenda"))
        ...
        { // Libera la memoria de la persona almacenado en la variable persona
            main_liberarPersona(persona);
        }
        else if (cmd_es("imprimirIdPersona", cmd))
        { // Imprime el id de la persona almacenado en la variable persona
            main_imprimirIdPersona(persona);
        }
        else if (cmd_es("imprimirEdadPersona", cmd))
        { // Imprime la edad de la persona almacenado en la variable persona
            main_imprimirEdadPersona(persona);
        }
        else if (cmd_es("imprimirNombrePersona", cmd))
        { // Imprime el nombre de la persona almacenado en la variable persona
            main_imprimirNombrePersona(persona);
        }
        else if (cmd_es("imprimirAgendaPersona", cmd))
        { // Imprime la agenda de la persona almacenado en la variable persona
            main_imprimirAgendaPersona(persona);
        }
        else if (cmd_es("imprimirPersona", cmd))
        { // Imprime todos los datos de la persona almacenado en la variable persona
            main_imprimirPersona(persona);
        }
        else if (cmd_es("agregarEventoPersona", cmd))
        { // Agrega el evento almacenado en la variable evento a la agenda de la persona almacenado en la variable persona
            main_agregarEventoPersona(persona, evento);
        }
        else if (cmd_es("posponerEventoPersona", cmd))
        { // Pospone el evento con Id pasado por parametro una cantidad de días indicada en la agenda de la persona almacenado en la variable persona
            main_posponerEventoPersona(persona);
        }
        else if (cmd_es("removerEventoPersona", cmd))
        { // Remueve el evento con Id pasado por parametro de la agenda de la persona almacenado en la variable persona
        ...
        else if (cmd_es("imprimirEventoPersona", cmd))
        { // Imprime el evento con Id pasado por parametro de la agenda de la persona almacenado en la variable persona
            main_imprimirEventoPersona(persona);
        }
        else if (cmd_es("imprimirCopiaPersona", cmd))
        { // Imprime una copia de la persona almacenado en la variable persona
        ...
        else if (cmd_es("crearListaPersonas", cmd))
        { // Crea una lista de personas y la almacena en la variable listaPersonas
            main_crearListaPersonas(listaPersonas);
        }
        else if (cmd_es("liberarListaPersonas", cmd))
        { // Libera la memoria de la lista de personas almacenada en la variable listaPersonas
            main_liberarListaPersonas(listaPersonas);
        }
        else if (cmd_es("imprimirListaPersonas", cmd))
        { // Imprime toda la información de la lista de personas almacenada en la variable listaPersonas
            main_imprimirListaPersonas(listaPersonas);
        }
        else if (cmd_es("insertarPersonaListaPersonas", cmd))
        { // Agrega la persona almacenada en la variable persona a la lista de personas almacenada en la variable listaPersonas
            main_insertarPersonaListaPersonas(listaPersonas, persona);
        }
        else if (cmd_es("imprimirPersonaListaPersonas", cmd))
        { // Imprime la persona con Id pasado por parametro de la lista de personas almacenada en la variable listaPersonas
